...
public class AlarmPurgeController extends AbstractController implements InitializingBean {
     ...
     * Logging
     */
    private static final Logger LOG = LoggerFactory.getLogger(AlarmPurgeController.class);
    ...
    protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try{	
    		...
    		ex.printStackTrace();
    		LOG.error("Unable to call junose rest api from alarm purge controller because of "+ex.getMessage());
    	}
        ...
        LOG.info("Job Id["+taskId+"] for your AlarmPurgeController action");
