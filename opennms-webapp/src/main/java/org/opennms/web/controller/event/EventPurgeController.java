...
public class EventPurgeController extends AbstractController implements
	...
	protected ModelAndView handleRequestInternal(
		...
		LOG.info("Enter into the EventPurgeController action");
		...
		try {
    		...
    		ex.printStackTrace();
    		LOG.error("Unable to marshall your event bean class because of  "+ex.getMessage());
    	} finally {
    		if(out != null){
    			out.close();
    		}
        ...
        try{	
    		...
    		ex.printStackTrace();
    		LOG.error("Unable to call junose rest api from event purge controller because of "+ex.getMessage());
    	}
        ...
        LOG.info("Terminated from the EventPurgeController action");
